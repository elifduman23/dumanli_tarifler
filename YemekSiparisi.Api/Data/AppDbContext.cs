    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MenuItem>().HasData(
                new MenuItem { Id = 1, RestaurantId = 1, Name = "Adana Kebap", Description = "Zırh kıyması, közlenmiş biber ve domates ile.", Price = 250, DiscountPrice = 200, Category = "Kebap", ImageUrl = "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=500", IsInStock = true },
                new MenuItem { Id = 2, RestaurantId = 1, Name = "Lahmacun", Description = "Bol malzemeli çıtır Antep lahmacunu.", Price = 80, DiscountPrice = 65, Category = "Kebap", ImageUrl = "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=500", IsInStock = true },
                new MenuItem { Id = 3, RestaurantId = 2, Name = "Margarita Pizza", Description = "Mozzarella, taze fesleğen ve domates sosu.", Price = 180, DiscountPrice = 149, Category = "Pizza", ImageUrl = "https://images.unsplash.com/photo-1604068549290-dea0e4a305ca?w=500", IsInStock = true },
                new MenuItem { Id = 4, RestaurantId = 3, Name = "Classic Burger", Description = "180gr köfte, karamelize soğan ve cheddar.", Price = 220, DiscountPrice = 199, Category = "Burger", ImageUrl = "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500", IsInStock = true }
            );
        }
    }
}
